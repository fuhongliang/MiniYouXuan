...
Page({
    ...
    onLoad: function(t) {
        ...
        console.log('devtool---',wx.getSystemInfoSync().platform);
    },
    ...
    selectCat: function(event) {
        ...
        var id = event.currentTarget.dataset.id;
        this.getCatGoodsList(id);
    },
    getCatGoodsList(cat_id) {
        var _that = this;
        getApp().request({
            url: getApp().api.default.cat_goods_list,
            data: {cat_id:cat_id},
            success: function(t) {
                if (0 == t.code) {
                    _that.setData({cat_goods_list:t.data.cat_goods_list,current_cat_id:t.data.current_cat_id});
                }
            },
            complete: function() {
            ...
            success: function(t) {
                if (0 == t.code) {
                   ...
                   _that.setData({
                        ...
                        btn: !0
                    }),_that.selectDefaultAttr(),_that.addCart();
                } else {
            ...
            getApp().request({
                ...
                success: function(t) {
                    if (0 == t.code) {
                        ...
                        e = 0 == s ? i % 60 + "秒" : s + "分" + i % 60 + "秒", t.cha_time <= 300 ? o.setData({
                            buy: {
                                time: e,
                                type: t.data.type,
                                url: t.data.url,
