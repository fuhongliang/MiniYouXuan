...
if (-1 !== siteinfo.acid) {
    ...
    _api_root = siteroot + "addons/zjhj_mall/core/web/index.php?_acid=" + siteinfo.acid + "&r=api/";
} else {
...
var api = {
    ...
    default: {
        ...
        cat_goods_list: _api_root + "default/cat-goods-list",
    ...
    share: {
        ...
        index: _api_root + "default/share-setting"
    },
    coupon: {
